...
using MvpCompanion.Portable.Extensions;
...
namespace MvpCompanion.Portable.ViewModels
{
    public class AddContributionsViewModel : PageViewModelBase
    {
        ...
        public AddContributionsViewModel()
        {
            ...
            EditCommand = new Command<ContributionsModel>(async cont => await EditContribution(cont));
            RemoveCommand = new Command<ContributionsModel>(async cont => await RemoveContribution(cont));
        ...
        public Command<ContributionsModel> EditCommand { get; set; }

        public Command<ContributionsModel> RemoveCommand { get; set; }
        ...
        public async void DatePicker_OnDateChanged(object sender, DateChangedEventArgs e)
        {
        ...
        public void ActivityType_SelectionChanged(object sender, EventArgs e)
        {
        ...
        public async void AddCurrentItemButton_Click(object sender, EventArgs e)
        {
        ...
        public void ClearCurrentItemButton_Click(object sender, EventArgs e)
        {
            SetupNextEntry();
        }

        public async void ClearQueueButton_Click(object sender, EventArgs e)
        {
            //try
            //{
        ...
        public async void UploadQueue_Click(object sender, EventArgs e)
        {
